  ...
  <div class="col-lg-12 mb-12">
	...
	<form name="form1" method="POST" enctype="multipart/form-data">	
		<div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tId" value="<?php echo $row->id_anggota; ?>"><?php echo form_error('tId'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tNama" value="<?php echo $row->nm_anggota; ?>"><?php echo form_error('tNama'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tAlamat" value="<?php echo $row->alamat; ?>"><?php echo form_error('tAlamat'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-2">
            <input type="date" class="form-control" name="tTtl" value="<?php echo $row->ttl_anggota; ?>"><?php echo form_error('tTtl'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tStatus" value="<?php echo $row->status; ?>"><?php echo form_error('tStatus'); ?>
          </div>
        </div>
