  ...
  <div class="col-lg-12 mb-12">
	...
	<form name="form1" method="POST" enctype="multipart/form-data">	
		<div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tId" value="<?php echo $id_buku; ?>"><?php echo form_error('tId'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tJudul" value="<?php echo set_value('tJudul') ?>"><?php echo form_error('tJudul'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tPengarang" value="<?php echo set_value('tPengarang') ?>"><?php echo form_error('tPengarang'); ?>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="tPenerbit" value="<?php echo set_value('tPenerbit') ?>"><?php echo form_error('tPenerbit'); ?>
          </div>
        </div>
